...
We decided to train the model to distinguish five possible situations:
1. Green Sign.
2. Red Sign.
3. No Sign.
4. Green Sign followed by a Red Sign.
5. Red Sign followed by a Green Sign.
...
======
 ...
 Мы решили обучить можель различать 5 возможных ситуаций:
 1. Зеленый Знак.
 2. Красный Знак.
 3. Нет Знака.
 4. Зеленый знак после которого идет красный знак.
 5. Красный знак после которого идет зеленый знак.

 Получается примерно по 2000 фотографий на каждую ситуацию. 
 На тестах в 90% случаях наша модель определяла расстановленные знаки точно.
